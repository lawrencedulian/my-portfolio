...
<template>
  <footer :style="{ backgroundColor: routeBgColor }">
    <section class="container socials rounded">
      <div class="row">
        <div
          class="socials-icon col-4 col-xl-4 col-lg-5 col-md-7 d-flex justify-content-between"
        >
          <a
            :href="social.link"
            v-for="(social, index) in store.social"
            :key="index"
          >
            <i :class="social.icon"></i>
          </a>
          <span class="text-white pe-none d-none d-md-block"
            >lawrence@edulian.com</span
          >
        </div>
      </div>
    </section>

    <section class="container copyright p-0 d-flex align-items-center">
      <p class="mb-0 ps-2 pe-none">COPYRIGHT 2025</p>
    </section>
  </footer>
</template>
